...
import { ImageBackground, View, ScrollView, StyleSheet, Text,  Animated,
  Image,
  Easing,
  Platform,
  TouchableOpacity,
      ...
      <ImageBackground source={require("../assets/images/Backdrop.png")}  style={{width: '100%', height: '100%'}}>
        <View style={{flexDirection:"column", justifyContent: "space-evenly", flex: 1}}>
          <View style={styles.progressBarContainer}>
            ...
            <View style={this.state.pressed ? styles.containerPressed : styles.bearContainer} {...this._panResponder.panHandlers}>
                <Animated.Image
                  style={{
                  ...
                  resizeMode="contain"
                  source={require("../assets/images/yellowbigbelly.png")}
                  />
            </View>
