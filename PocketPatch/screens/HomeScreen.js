      ...
      <View style={{ flex: 1, backgroundColor: "#DDDDFF", paddingBottom: 50 }}>
        <View style={styles.container}>
          ...
          <TouchableOpacity
            ...
            onPress={() => this.props.navigation.navigate("Links", {name: this.props.navigation.state.params.name, timing:[2000,2000,2000]})}
          >
            <View>
              <Image
          ...
          <TouchableOpacity
            style={styles.container}
            onPress={() => this.props.navigation.navigate("Links", {name: this.props.navigation.state.params.name, timing:[1500,1750,2000]})}
          >
            <View>
              <Image
                style={{ height: 100, resizeMode: "contain" }}
          ...
          <TouchableOpacity
            style={styles.container}
            onPress={() => this.props.navigation.navigate("Links", {name: this.props.navigation.state.params.name, timing:[1000,1500,2000]})}
          >
            <View>
              <Image
                style={{ height: 100, resizeMode: "contain" }}
